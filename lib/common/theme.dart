...
class appTheme {
  ...
  // static const Color mainGreen = Color(0xFF314E52);
  static const Color mainGreen = Color(0xFF145374);
  // static const Color mainGreen = Color(0xFF00334E);
  ...
  static const Color test4 = Color.fromRGBO(111, 138, 98, 1);

  static const Color mainBeige = Color(0xFFF8F5F1);
}